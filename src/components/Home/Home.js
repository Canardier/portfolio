        ...
        <section id="about" className="about-section">
            ...
            <div className="wrap_element md:flex justify-center grid grid-cols-3 gap-3">
                ...
                <div className='Trust justify-center md:px-10 px-5'>
                    <img alt="image d'une poignée de main" src={`${process.env.PUBLIC_URL}/Trust_logo/api.svg`} className="h-20 w-auto" />
                    <p className='md:text-center'>Trust</p>
                </div>
                <div className='Architecture justify-center md:px-10 px-5'>
                    <img alt="image d'une pile" src={`${process.env.PUBLIC_URL}/Trust_logo/api.svg`} className="h-20 w-auto md:px-1" />
                    <p className='md:text-center'>Architecture</p>
                </div>
                <div className='Containerisation md:px-10 px-5'>
                    <img alt="Image de baleine" src={`${process.env.PUBLIC_URL}/Trust_logo/api.svg`} className="h-20 w-auto md:px-3" />
