...
const Home = () => {
    return (
        <section id="about" className="about-section min-h-screen">
            ...
            <div className="wrap_element md:flex justify-center grid grid-cols-3 gap-3">
                <div className='Api md:px-10 px-5'>
                    <img alt="image qui designe une api" src="/mylogo/api.svg" className="h-20 w-auto" />
                    <p className='md:text-center'>Api building</p>
                </div>
                <div className='Trust justify-center md:px-10 px-5'>
                    <img alt="image d'une pile" src="/mylogo/poignee-de-main.svg" className="h-20 w-auto" />
                    <p className='md:text-center'>Trust</p>
                </div>
                <div className='Architecture justify-center md:px-10 px-5'>
                    <img alt="image d'une pile" src="/mylogo/couches.svg" className="h-20 w-auto md:px-1" />
                    <p className='md:text-center'>Architecture</p>
                </div>
                <div className='Containerisation md:px-10 px-5'>
                    <img alt="Image de baleine" src="/mylogo/baleine.svg" className="h-20 w-auto md:px-3" />
                    <p className='md:text-center'>Containerisation</p>
                </div>
                <div className='Human md:px-10 px-5 col-end-4'>
                    <img alt="Quorix" src="/mylogo/picpersonnes-remplies-big.svg" className="h-20 w-auto md:px-3" />
